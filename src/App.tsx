  ...
  return (
    <div className="relative min-h-screen text-white flex flex-col items-center p-6 overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-orange-900 via-rose-900 to-amber-800" />

        {/* Animated liquid blobs */}
        <div className="absolute top-0 -left-20 w-96 h-96 bg-gradient-to-br from-orange-400/30 to-red-500/30 rounded-full blur-3xl liquid-blob" style={{ animationDelay: '0s' }} />
        <div className="absolute top-40 right-0 w-80 h-80 bg-gradient-to-br from-amber-400/30 to-orange-500/30 rounded-full blur-3xl liquid-blob" style={{ animationDelay: '5s' }} />
        <div className="absolute bottom-20 left-1/3 w-96 h-96 bg-gradient-to-br from-rose-400/30 to-pink-500/30 rounded-full blur-3xl liquid-blob" style={{ animationDelay: '10s' }} />
        <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-gradient-to-br from-red-400/30 to-rose-500/30 rounded-full blur-3xl liquid-blob" style={{ animationDelay: '15s' }} />
