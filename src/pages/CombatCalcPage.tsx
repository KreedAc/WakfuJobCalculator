...
const TABS = ['⚔️ Damage','❤️ Heal','💚 Armor','⚖️ Build','💙 Tank','📏 Resistance','⚡ FoW','⛓️ Lock','🩸 HP/EHP','🗡️ EM'] as const;
  ...
  return (
    <div className="max-w-4xl w-full flex flex-col items-center animate-in fade-in duration-500">
      ...
      <div className="w-full">
        ...
        {tab==='💙 Tank' && (
          <div className="glass rounded-3xl p-6 space-y-3">
            <h2 className="text-lg font-bold text-emerald-200 border-b border-emerald-500/18 pb-3">💙 Tankiness — EHP Comparison</h2>
