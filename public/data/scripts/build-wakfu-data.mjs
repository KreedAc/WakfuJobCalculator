...
const pickRowRecipeId = (o) =>
  o?.recipeId ?? o?.definition?.recipeId ?? o?.recipeDefinitionId ?? o?.definition?.recipeDefinitionId ?? o?.definitionId ?? null;

const pickIngItemId = (o) =>
  o?.itemId ?? o?.definition?.itemId ?? o?.ingredientId ?? o?.definition?.ingredientId ?? null;

const pickResItemId = (o) =>
  o?.itemId ?? o?.definition?.itemId ?? o?.resultItemId ?? o?.definition?.resultItemId ?? null;

const pickQty = (o) => o?.quantity ?? o?.qty ?? o?.definition?.quantity ?? o?.resultQty ?? 1;
...
// parsing streaming semplice di items.json (array enorme)
